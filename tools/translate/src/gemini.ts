...
export class GeminiTranslator {
  ...
  async translate(
    ...
    const prompt = this.buildPrompt(entries, targetLanguage);
  ...
  private buildPrompt(entries: MergedEntry[], targetLanguage: string): string {
...
{"key1": "translated value 1", "key2": "translated value 2"}`;
  ...
  private parseResponse(response: string): TranslationMap {
